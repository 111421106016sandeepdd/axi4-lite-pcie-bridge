...
- Write/readback verification across multiple addresses
- Completion-based response handling back to AXI

### Design Features Verified
- FIFO buffering between request and transmit stages
- Packetized transaction flow
- Address range filtering through config registers
...
- Demonstrated FIFO-based buffering and completion-driven response handling
- Generated waveform-based proof for write flow, read flow, and readback verification
...
- Integrated memory model in the RX engine
- Completion packet validation and AXI response checking
- GTKWave-based signal inspection and debug
